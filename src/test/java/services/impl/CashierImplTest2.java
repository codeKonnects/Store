...
class CashierImplTest2 {
    ...
    void sellProductOnPriority() {
        ...
        String actual = daroImpl.sellProductOnPriority(product);
        String expected = "Chocolate Chip has been sold  to david";
